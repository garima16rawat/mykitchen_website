...
def order(request):
    ...
    if request.method == 'POST':
        ...
        if filled_form.is_valid():
            created_pizza=filled_form.save() #save the pizza in our database
        ...
        new_form = PizzaForm()
        return render(request, 'pizza/order.html', {'crested_pizza_pk':created_pizza_pk,'pizzaform':new_form, 'note':note,'multiple_form':multiple_form})
    else:
        form = PizzaForm()
